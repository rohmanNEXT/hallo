...
const SidebarPembuat: React.FC<SidebarProps> = ({
  user,
  items,
  activeTab,
  onTabChange,
  ...
  return (
    <>
      <div className="flex flex-col overflow-hidden">
        {/* User Info (design matches pencari-kerja) */}
        ...
        <div className="overflow-y-auto pt-5 pb-2 space-y-4">
          {menuTitle && (
            <span className="text-[10px] font-bold text-muted-foreground/60 uppercase tracking-widest px-3.5 block mb-1">
              {menuTitle}
            </span>
          )}
