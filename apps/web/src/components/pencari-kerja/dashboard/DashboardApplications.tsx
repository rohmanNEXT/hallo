                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 bg-primary/20 text-foreground text-[12px] font-bold rounded-lg hover:bg-primary/30 border border-primary/30 transition-all cursor-pointer"
                    >
