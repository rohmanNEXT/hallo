        ...
        <div className="flex gap-2">
          {showDetail && (
            <button
              ...
              className="px-3 py-1.5 border border-border bg-transparent hover:bg-muted text-foreground text-[11px] font-bold rounded-lg transition-all cursor-pointer flex items-center gap-1"
            >
              Detail
          ...
          {offer.status === 'Menunggu' && (
            <>
              <button
                ...
                className="px-3 py-1.5 bg-rose-500/20 text-foreground hover:bg-rose-500/30 text-[11px] font-bold rounded-lg transition-all cursor-pointer"
              >
                Tolak
              </button>
              <button
                onClick={() => onUpdateStatus(offer.id, 'Diterima')}
                className="px-3 py-1.5 bg-emerald-500/20 text-foreground hover:bg-emerald-500/30 text-[11px] font-bold rounded-lg transition-all cursor-pointer"
              >
                Terima
              </button>
            </>
          ...
          {(offer.status === 'Diterima' || offer.status === 'Ditolak') && (
            <button
              ...
              className="px-3 py-1.5 bg-primary/20 text-foreground text-[11px] font-bold rounded-lg hover:bg-primary/30 transition-all cursor-pointer flex items-center gap-1.5"
            >
    ...
    <div className="bg-card border border-border/70 rounded-3xl p-5 md:p-6 shadow-sm flex flex-col h-[880px] overflow-hidden animate-in fade-in duration-300 justify-between">
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <div className="space-y-1 pb-4 border-b shrink-0 mb-4 flex items-center justify-between">
          <div>
            <span className="text-base font-extrabold text-foreground tracking-tight flex items-center gap-2 block">
