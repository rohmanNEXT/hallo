                    ...
                    <div className="flex gap-2 pt-1.5 justify-center md:justify-start">
                      {company.website && (
                        <a
                          ...
                          title="Website Resmi"
                          className="inline-flex items-center justify-center border border-input bg-background hover:bg-accent hover:text-accent-foreground rounded-lg h-7 w-7 hover:bg-accent/30 cursor-pointer text-muted-foreground transition-all shadow-sm"
                        >
                ...
                <div className="flex flex-wrap gap-2.5">
                  {company.benefits?.map((benefit, i) => (
                    <Badge
                      key={i}
                      variant="outline"
                      className={`text-[11.5px] font-normal px-2.5 py-0.5 h-6 rounded-full shadow-sm flex items-center ${
                        mounted && theme === 'white'
