...
const LowonganPageContent: React.FC = () => {
      ...
      <div className="flex-1 w-full mx-auto px-4 md:px-8 py-6 md:py-10 flex flex-col md:flex-row gap-8 h-auto overflow-hidden max-w-7xl">
        <section className="flex-1 min-w-0 h-full">
          <div className="w-full space-y-8">
            <LowonganTab updateTabInUrl={handleTabNavigation} />
          </div>
        </section>
      </div>
    </main>
...
const ProtectedContent = withAuth(LowonganPageContent, undefined, { role: 'HRD', redirectTo: '/pembuat-kerja/kandidat' });
