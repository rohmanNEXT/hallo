        ...
        <div className="border-b border-border/60 pb-4 space-y-4">
          ...
          <div className="flex gap-8">
            <button
              ...
              className={`pb-2.5 text-sm font-semibold transition-all border-b-2 mb-[-18px] cursor-pointer bg-transparent border-none ${
              ...
              {[
                ...
                return (
                  <button
                    ...
                    className={`pb-2.5 text-xs md:text-sm font-semibold transition-all border-b-2 -mb-px cursor-pointer bg-transparent border-none ${
                      isActive
                        ? 'text-foreground'
                        : 'border-transparent text-muted-foreground hover:text-foreground'
                    }`}
