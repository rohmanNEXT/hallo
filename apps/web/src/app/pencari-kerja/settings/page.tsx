...
export default function SettingsPage() {
  const { settings, updateSettings, user, updateProfile, logout } =
    useAppStore();
          ...
          {[
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 pb-3 text-base font-semibold transition-all border-b-2 -mb-px cursor-pointer ${
                  isActive
                    ? 'text-foreground'
                  ...
                  {[
                    {
                      ...
                      icon: <LuGlobe className="w-4 h-4 text-blue-500" />,
                    },
                    {
                      name: 'LinkedIn',
                      connected: connected.includes('LinkedIn'),
                      icon: <LuLinkedin className="w-4 h-4 text-blue-700" />,
                    },
                    {
                      name: 'Microsoft',
                      connected: connected.includes('Microsoft'),
                      icon: <LuMonitor className="w-4 h-4 text-sky-500" />,
                    },
                  ].map((acc) => (
                    <div
                      key={acc.name}
            ...
            <div className="border border-border/70 bg-card p-6 rounded-2xl shadow-sm space-y-4">
              ...
              <div className="flex flex-col gap-3 pt-1">
                {[
                  {
                    id: 'Public',
                    title: <span className="flex items-center gap-1.5"><Unlock className="w-4 h-4 shrink-0 text-muted-foreground" /> Publik (Semua Rekruter)</span>,
                    desc: 'Profil, resume, dan portofolio Anda dapat ditemukan oleh semua perusahaan.',
                  },
                  {
                    id: 'Premium Only',
                    title: <span className="flex items-center gap-1.5"><Gem className="w-4 h-4 shrink-0 text-blue-400" /> Rekruter Premium</span>,
                    desc: 'Hanya perusahaan premium yang dapat melihat info profil lengkap Anda.',
                  },
                  {
                    id: 'Private',
                    title: <span className="flex items-center gap-1.5"><Lock className="w-4 h-4 shrink-0 text-muted-foreground" /> Privat / Tersembunyi</span>,
