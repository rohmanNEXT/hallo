...
export default function ProfilePage() {
  const { user, updateProfile, bannerIndex, setBannerIndex } = useAppStore();
        ...
        <div className="print-profile-root" style={{ background: '#09090b', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '40px 32px', fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, sans-serif" }}>
          ...
          <div style={{
            ...
            <div style={{ padding: '48px 48px 32px', textAlign: 'center' }}>
              ...
              {/* Career / Subtitle */}
              {user.career && (
                <p style={{ fontSize: 16, color: '#a78bfa', fontWeight: 600, margin: '0 0 16px' }}>
                  {user.career}
                </p>
              )}
          ...
          <div className="px-6 md:px-8 pb-6 relative">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between -mt-12 sm:-mt-15 gap-4 mb-6">
              ...
              <div className="flex justify-center sm:justify-end gap-2">
                ...
                <Button
                  onClick={() => router.push('/pencari-kerja/settings')}
                  variant="outline"
                  size="sm"
                  className="h-9 gap-1.5 cursor-pointer font-bold border-border/60 text-xs"
                >
                  ...
                  {formData.softFile ? (
                    <div className="flex items-center justify-between bg-muted/40 border border-border/80 rounded-xl p-2.5">
                      ...
                      <button
                        ...
                        className="text-destructive hover:bg-destructive/10 p-1.5 rounded-lg transition-colors cursor-pointer border-none bg-transparent"
                      >
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1 shrink-0">
                        <button
                          ...
                          className="text-muted-foreground hover:bg-muted p-1.5 rounded-lg transition-colors cursor-pointer border-none bg-transparent"
                          title="Edit item"
                        >
                          <Pencil className="h-4 w-4" />
                        </button>
                  ...
                  {formData.skill.map((sk: string) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="p-0.5 hover:bg-primary/20 rounded-full transition-colors text-primary/80 hover:text-primary cursor-pointer border-none bg-transparent"
                      >
                        <X className="h-3 w-3" />
                      </button>
                    </div>
                  ...
                  {formData.certificates.map((cert: string) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="text-destructive hover:bg-destructive/10 p-1 rounded-md transition-colors border-none bg-transparent cursor-pointer"
                      >
                  ...
                  user.certificates.map((cert: string) => (
                    ...
                    >
                      ...
                      <button
                        onClick={() =>
                          router.push(
                            `/pencari-kerja/profile/preview?name=${encodeURIComponent(cert)}`,
                          )
                        }
              ...
              <div className="space-y-4">
                <div className="space-y-3 bg-background/40 p-4 rounded-xl border border-border/70">
                  ...
                  <Button
                    ...
                    size="sm"
                    className="w-full h-9 cursor-pointer text-xs font-bold"
                  >
                    Tambah Organisasi
                  </Button>
                </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-in fade-in duration-200">
            <div className="bg-card border border-border/80 w-full max-w-sm rounded-3xl p-5 relative shadow-2xl animate-in scale-in duration-200">
              <button
                ...
                className="absolute top-4 right-4 p-1.5 hover:bg-muted rounded-full transition-colors cursor-pointer text-muted-foreground hover:text-foreground border-none bg-transparent"
              >
                <X className="h-4 w-4" />
              </button>
